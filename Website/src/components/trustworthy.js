	...
	render() {
		...
		return (
			<div className='trust_container'>
				<Navi></Navi>
				<Container className='trust_heading'>
					<h2>{this.state.name}</h2>
				</Container>
				<div className='trust_heading_lecture'>
					<Button className='trust_small_button'>
					...
					<br></br>
					<br></br>
					<div className='trust_container_header'>
						<Button className='trust_button'>Trustworthyness</Button>

						<div className='trust_container_header'>
							<div className='trust_index1'>
