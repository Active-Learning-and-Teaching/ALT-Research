          ...
          Trustworthy Index
            ...
            <div className="App-header">
                ...
                <LineChart width={9000}
                        height={6000} data={this.state.trustworrthy_arr1} margin={{ right: 100 }}>
                    <CartesianGrid />
                    <XAxis dataKey="name" 
                    ...
                    <Legend />
                    <Tooltip />
                    <Line dataKey="trustworthy_index_1"
                ...
                <ResponsiveContainer width="100%" >
                <LineChart width={9000}
                        height={6000} data={this.state.trustworthy_arr2} margin={{ right: 100 }}>
                    <CartesianGrid />
                    <XAxis dataKey="name" 
                        interval={'preserveStartEnd'} />
                    <YAxis></YAxis>
                    <Legend />
                    <Tooltip />
                    <Line dataKey="trustworthy_index_2"
                        stroke="blue" activeDot={{ r: 8 }} />
                </LineChart>
            </ResponsiveContainer>
                </div>
