...
class Under_Eng_Overall extends React.Component {
	...
	render() {
		return (
			<div className='engOverall_container'>
				<Container className='engOverall_heading'>
					<h2>{this.state.name}</h2>
				</Container>
				<div className='engOverall_heading_lecture'>
					<br></br>
					<br></br>
					<br></br>
					<br></br>
					<div className='engOverall_container_header'>
						<Button onClick={() => this.operation_understanding()} className='engOverall_button'>
							Understanding
						</Button>

						<Button onClick={() => this.operation()} className='engOverall_button'>
							Engagement
						</Button>

						{this.state.showMe ? (
							<div className='engOverall_container_header'>
								<div className='engOverall_index1'>
									...
									<ResponsiveContainer width='100%'>
										...
										>
											...
											<Legend />
											<Tooltip />
											<Line dataKey='understanding_index_1' stroke='blue' activeDot={{ r: 8 }} />
										</LineChart>
									</ResponsiveContainer>
								</div>

								<div className='engOverall_index2'>
									...
									<ResponsiveContainer width='100%'>
										...
										>
											...
											<Legend />
											<Tooltip />
											<Line dataKey='understanding_index_2' stroke='blue' activeDot={{ r: 8 }} />
										</LineChart>
									</ResponsiveContainer>
								</div>

								<div className='engOverall_index3'>
									...
									<ResponsiveContainer width='100%'>
										...
										>
											...
											<Legend />
											<Tooltip />
											<Line dataKey='understanding_index_3' stroke='blue' activeDot={{ r: 8 }} />
										</LineChart>
									</ResponsiveContainer>
								</div>
							</div>
								...
								<div className='engOverall_index1'>
									...
									<ResponsiveContainer width='100%'>
										...
										>
											...
											<Legend />
											<Tooltip />
											<Line dataKey='engagement_index_1' stroke='blue' activeDot={{ r: 8 }} />
										</LineChart>
									</ResponsiveContainer>
								</div>
								...
								<div className='engOverall_index2'>
									...
									<ResponsiveContainer width='100%'>
										...
										>
											...
											<Legend />
											<Tooltip />
											<Line dataKey='engagement_index_2' stroke='blue' activeDot={{ r: 8 }} />
										</LineChart>
									</ResponsiveContainer>
								</div>
								...
								<div className='engOverall_index3'>
									...
									<ResponsiveContainer width='100%'>
										...
										>
											...
											<Legend />
											<Tooltip />
											<Line dataKey='engagement_index_3' stroke='blue' activeDot={{ r: 8 }} />
										</LineChart>
									</ResponsiveContainer>
								</div>
							</div>
